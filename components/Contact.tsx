      ...
      <div className="mx-auto max-w-6xl px-6 py-24 sm:py-32">
        <Reveal>
          ...
          <p className="mt-6 max-w-2xl text-lg text-muted">
            {site.availability} — and available for freelance marketing
            projects. If you need someone who understands both the codebase
            and the business, I&apos;d love to talk.
          </p>
